...
function App() {
  ...
  <TabsList className="inline-flex bg-blue-100 dark:bg-blue-900 transform scale-110 sm:scale-135 md:scale-[1.8] w-full max-w-xs sm:max-w-md md:max-w-lg">
      ...
      <TabsTrigger value="projects" className="flex-1">
        <span className="text-slate-900 dark:text-slate-100 text-sm sm:text-base">Projects</span>
      </TabsTrigger>
      <TabsTrigger value="contact" className="flex-1">
        <span className="text-slate-900 dark:text-slate-100 text-sm sm:text-base">Contact</span>
      </TabsTrigger>
    </TabsList>
  </div>
